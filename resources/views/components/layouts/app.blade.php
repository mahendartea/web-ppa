...
<head>
    ...
    <link rel="icon" href="/assets/img/logopartaipres.png" type="image/x-icon">
...
<body class="bg-yellow-50">
    <a type="button" id="btn-sticky" href="{{ route('registerasi') }}"
        class="hidden fixed z-50 top-72 -left-16 rounded-b-md py-3 px-5 p-2 bg-[#040181] text-white font-bold text-sm -rotate-90 shadow-md transition duration-300 hover:bg-blue-600 uppercase hover:shadow-lg">
        Daftar Anggota
    </a>
    ...
    <footer class="bg-[#040181] dark:bg-gray-900 text-white pt-16 pattern">
            ...
            <div class="mt-6 md:mt-0 md:flex-1">
                <div class="grid grid-cols-1 gap-0 md:gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                        ...
                        <a href="#" class="block mt-2 text-sm  dark:text-gray-400 hover:underline">Kegiatan</a>
        ...
        <div class="text-center dark:text-gray-400">
            <p> Partai Perjuangan Aceh 2024 - All rights reserved</p>
        </div>
    </footer>
