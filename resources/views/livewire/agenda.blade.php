<div>
    <section class="relative bg-yellow-50 mt-28">
            ...
            <div class="w-full max-w-7xl mx-auto px-2 lg:px-8">
                <div class="grid grid-cols-12 gap-8 max-w-4xl mx-auto xl:max-w-full">
                    <div class="col-span-12 xl:col-span-5">
                        <h2 class="font-manrope text-3xl leading-tight text-gray-900 mb-1.5">Agenda Berikutnya
                        </h2>
                        <p class="text-lg font-normal text-gray-600 mb-8">Jangan Ketinggalan Agendanya</p>
                        <div class="flex gap-5 flex-col">
                            <div class="p-6 rounded-xl bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center gap-2.5">
                                        <span class="w-2.5 h-2.5 rounded-full bg-purple-600"></span>
                                        <p class="text-base font-medium text-gray-900">Jan 10,2020 - 10:00 -
                                            11:00</p>
                                    </div>
                                </div>
                                <h6 class="text-xl leading-8 font-semibold text-black mb-1">Sosialisasi Partai
                                    Perjuangan Aceh</h6>
                                <p class="text-base font-normal text-gray-600">Sosialisasi Partai Perjuangan Aceh
                                    di
                                    Banda Aceh</p>
                            </div>
                            <div class="p-6 rounded-xl bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <p class="text-base font-medium text-gray-900">Jan 15,2020 - 13:00 -
                                            14:00</p>
                                    </div>
                                </div>
                                <h6 class="text-xl leading-8 font-semibold text-black mb-1">Rapat Koordinasi
                                    Partai</h6>
                                <p class="text-base font-normal text-gray-600">Rapat Koordinasi Partai Perjuangan
                                    Aceh di
                                    Jakarta</p>
                            </div>
                            <div class="p-6 rounded-xl bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <p class="text-base font-medium text-gray-900">Jan 17,2020 - 08:00 -
                                            09:00</p>
                                    </div>
                                </div>
                                <h6 class="text-xl leading-8 font-semibold text-black mb-1">Penggalangan
                                    Dana</h6>
                                <p class="text-base font-normal text-gray-600">Penggalangan Dana Partai
                                    Perjuangan Aceh di
                                    Medan</p>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col md:flex-row gap-4 items-center justify-between mb-5">
                            <div class="flex items-center gap-4">
                                <h5 class="text-xl leading-8 font-semibold text-gray-900">Oktober 2024</h5>
